...
<P>This Item Costs $5.55</P>
	
<input name=addbox type=button value="Add This Item To My Order" onclick=Loc_additem('p3i1','5.55','Page_3_Item_1','pagethree.php')>

<br>
	
<input type=button name=subbox value="Subtract This Item From My Order" onclick=Loc_subitem('p3i1','5.55','Page_3_Item_1','pagethree.php')>
...
<P>This Item Costs $6.66</P>		
<input name=addbox type=button value="Add This Item To My Order" onclick=Loc_additem('p3i2','6.66','Page_3_Item_2','pagethree.php')>

<br>
	
<input type=button name=subbox value="Subtract This Item From My Order" onclick=Loc_subitem('p3i2','6.66','Page_3_Item_2','pagethree.php')>
...
<P>This Item Costs $7.77</P>		
	
<input name=addbox type=button value="Add This Item To My Order" onclick=Loc_additem('p3i3','7.77','Page_3_Item_3','pagethree.php')>
	
<br>
	
<input type=button name=subbox value="Subtract This Item From My Order" onclick=Loc_subitem('p3i3','7.77','Page_3_Item_3','pagethree.php')>
